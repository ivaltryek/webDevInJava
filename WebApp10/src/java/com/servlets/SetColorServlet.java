...
public class SetColorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            ArrayList<com.beans.Color> colorList=new ArrayList();
            ...
            colorList.add(new Color("Black","000000"));
            colorList.add(new Color("Gray","080808"));
            colorList.add(new Color("Yellow","FFFF00"));
            
            request.setAttribute("colorList",colorList);
            request.getRequestDispatcher("showColors.jsp").forward(request,response);
    }
