...
public class Hibernatecrud {
    ...
    public static void main(String ar[]){
        ...
        Hibernatecrud.createRecord();
        //Hibernatecrud.retrieveData();
      //  Scanner sc = new Scanner(System.in);
      //  System.out.println("Enter id for record to update: ");
        //updateId = sc.nextInt();
        //Hibernatecrud.updateData(updateId);
       // Hibernatecrud.deleteData(updateId);
    }
}
